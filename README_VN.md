...
### 1. Fork Repository
[Fork dự án này](../../fork) về tài khoản GitHub của bạn để có thể tùy chỉnh tính năng và quản lý các quy tắc DNS của riêng bạn.

### 2. Triển khai lên Cloudflare Pages
1.  Vào [Workers & Pages > Pages > Create application > Connect to Git](https://dash.cloudflare.com/?to=/:account/pages/new/provider/github).
